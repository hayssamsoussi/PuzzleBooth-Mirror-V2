...
class OreoWifiManager(private val context: Context) : HotspotManager() {
    ...
    override fun start() {
        ...
        try {
            ...
            try {
                ...
                println("hhh startTethering invoked")
            } catch (e: Exception) {
                println("hhh Error in enableTethering")
                e.printStackTrace()
            ...
            println("hhh Error in enableTethering ProxyBuilder")
            e.printStackTrace()
            hotspotLiveData.postValue(
                HotspotEvent(
                    HotspotEvent.Type.START_ERROR,
    ...
    private fun onStartTetheringCallbackClass(): Class<*>? {
        try {
            ...
            println("hhh onStartTetheringCallbackClass error: %s" + e.message)
            e.printStackTrace()
        }
